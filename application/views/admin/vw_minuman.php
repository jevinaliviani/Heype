            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="<?= base_url('assets/') ?>img/bg-img/mi1.jpg" alt="">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="<?= base_url('assets/') ?>img/bg-img/mi2.jpg" alt="">
                        <div class="receipe-content">
                            <a href="receipe-post.html">
                                <h5>Teh Hangat</h5>
                            </a>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="<?= base_url('assets/') ?>img/bg-img/mi3.jpg" alt="">
                        <div class="receipe-content">
                            <a href="receipe-post.html">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="<?= base_url('assets/') ?>img/bg-img/mi4.jpg" alt="">
                        <div class="receipe-content">
                            <a href="receipe-post.html">
                                <h5>Jus Jeruk</h5>
                            </a>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="<?= base_url('assets/') ?>img/bg-img/mi5.jpg" alt="">
                        <div class="receipe-content">
                            <a href="receipe-post.html">
                                <h5>Jus Alpukat</h5>
                            </a>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="<?= base_url('assets/') ?>img/bg-img/mi6.jpg" alt="">
                        <div class="receipe-content">
                            <a href="receipe-post.html">
                                <h5>Lemon Tea</h5>
                            </a>
